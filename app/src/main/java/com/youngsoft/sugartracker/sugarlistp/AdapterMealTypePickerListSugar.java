...
public class AdapterMealTypePickerListSugar extends ListAdapter<Integer, AdapterMealTypePickerListSugar.ViewHolder> {
    ...
    public AdapterMealTypePickerListSugar(OnMealTypeClickListener onMealTypeClickListener) {
        super(DIFF_CALLBACK);
    ...
    @NonNull
    @Override
    public AdapterMealTypePickerListSugar.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_meal_picker, parent, false);
        return new AdapterMealTypePickerListSugar.ViewHolder(view, onMealTypeClickListener);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterMealTypePickerListSugar.ViewHolder holder, int position) {
