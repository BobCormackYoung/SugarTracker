...
public class FragmentMealTypePickerSugar extends DialogFragment implements AdapterMealTypePickerListSugar.OnMealTypeClickListener{

    ViewModelAddSugarMeasurement viewModelAddSugarMeasurement;
    View view;
    RecyclerView recyclerView;
    ArrayList<Integer> mealTypeArrayList;
    AdapterMealTypePickerListSugar adapterMealTypePickerList;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        adapterMealTypePickerList = new AdapterMealTypePickerListSugar(this);
